...
// import { EditBarang } from './components/dialog';
...
//     const { getBarang, postBarang, history } = useControllerState()
//     const [editBarang, setEditBarang] = useState(null)
//     const [id_kontrak, setIdKontrak] = useState(null)

//     const [tambah_barang, setTambahBarang] = useState(false)
//     const [detail_barang, setDetailBarang] = useState(null)


//     const getBarangOfKontrak = (data, id) => {
//         // setBarang()
...
//                                     action: (detail_kontrak, id_kontrak) => getBarangOfKontrak(detail_kontrak, id_kontrak)
//                                 }
...
//                 {
//                     [...new Set(barangState.map(a => {
//                         return a.id_barang
//                     }))].sort((a, b) => new Date(b.created_date) - new Date(a.created_date)).map(item => {
//                         const barang = barangState.find(b => b.id_barang == item)
//                         return (
//                             <Barang.DataCard
...
//                                 {
//                                     ...barang,
//                                     edit: (data) => setEditBarang(data),
//                                     info: () => setDetailBarang(item)
//                                 }
//                                 }
